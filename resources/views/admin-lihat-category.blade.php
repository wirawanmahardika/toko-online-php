<x-admin-layout>
    <div class="w-full p-5 grid grid-cols-3 gap-5 overflow-y-auto ">
        ...
        @foreach ($kategoris as $kategori)
            <div
                class="p-5 flex flex-col gap-y-5 items-center border-2 border-black rounded-lg shadow-lg h-full justify-end">
                <img class="max-w-[66%]" src="{{ $kategori->imageUrl }}" alt="{{ $kategori->name }}" />
